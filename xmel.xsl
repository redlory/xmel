...
<td>
    <xsl:value-of select="Документ/Организация/Реквизиты/@Наим|Документ/Организация/Реквизиты/@НаимЮЛ|Документ/Организация/Реквизиты/@НаимОрг"/>
</td>
</tr>
<tr><th>ИНН:</th>
<td>
...
<xsl:template name="ПоставкиЗакупкиПодразделения">
    ...
    <td colspan="15">
        <xsl:value-of select="@НаимЮЛ|@Наим"/>,
        КПП: <xsl:value-of select="@КППЮЛ"/>.
        <xsl:apply-templates select="АдрОрг"/>
    </td>
    </tr>
